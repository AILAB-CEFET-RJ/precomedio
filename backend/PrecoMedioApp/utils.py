...
# Função para fazer a pesquisa no Google Shopping utilizando web scraping
...
# Função para fazer a pesquisa no Google Shopping utilizando a API do SerpApi
def fazer_pesquisa(pesquisa):
    params = {
...
# Função complementar da função fazer_pesquisa
...
# Função para obter modelos e preços dos produtos encontrados utilizando o web scraping do Google Shopping
...
# Função para obter modelos e preços dos produtos encontrados de acordo com o retorno da API do SerpApi
