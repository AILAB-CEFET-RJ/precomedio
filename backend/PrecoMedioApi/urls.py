...
from PrecoMedioApp.views import search, login, signup, save_favorites, get_favorites, buscaDiaria_alimentarConsolidada, get_prices_monthly_history, list_min_price_per_product
...
urlpatterns = [
    ...
    path('history/', get_prices_monthly_history, name='get_prices_monthly_history'),
